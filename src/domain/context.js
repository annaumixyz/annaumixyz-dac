...
function createStatusService(bot) {
  return {
    async fetchNormalizedStatus({ force = false } = {}) {
      ...
      const status = statusDomain.normalizeStatus({
